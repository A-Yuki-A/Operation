    ...
    digraph devices {{
      ...
      memory [label=<
        <TABLE BORDER=0 CELLBORDER=0 CELLSPACING=0>
          <TR><TD ALIGN=LEFT POINT-SIZE=20>{mem_html}</TD></TR>
        </TABLE>
      >, fillcolor=\"{color_mem}\", color=\"black\"];
      cpu    [label=<
        <TABLE BORDER=0 CELLBORDER=0 CELLSPACING=0>
          <TR><TD ALIGN=LEFT POINT-SIZE=20>{cpu_html}</TD></TR>
        </TABLE>
      >, fillcolor=\"{color_cpu}\", color=\"black\"];
      keyboard [label=<
        <TABLE BORDER=0>
          <TR><TD ALIGN=LEFT POINT-SIZE=20>キーボード</TD></TR>
        </TABLE>
      >, fillcolor=\"#F8D7DA\", color=\"black\"];
      display  [label=<
        <TABLE BORDER=0>
          <TR><TD ALIGN=LEFT POINT-SIZE=20>ディスプレイ</TD></TR>
        </TABLE>
